...
struct ServeCommand: AsyncParsableCommand {
    ...
    @Option(name: .long, help: "Upstream provider (openai, groq, zai, openrouter, xai, chutes, google, deepseek, mistral, minimax, minimax-cn, alibaba-coding, ollama, lmstudio).")
